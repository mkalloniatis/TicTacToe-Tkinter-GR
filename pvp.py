...
class Board():
    ...
    def __init__(self):
        ...
        self.frame = tk.Frame(self.window, bg = "#000000")    

    def create_window(self):
        self.label.pack()
        self.frame.pack(expand=True,padx=100, pady=20)
        ...
        for row in range(3):
            self.frame.rowconfigure(row, weight=1, minsize= 200)
            self.frame.columnconfigure(row, weight=1, minsize= 200)
            for col in range(3):
